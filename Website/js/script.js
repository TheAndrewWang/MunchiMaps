...
//generating the description based on image that it is given
      ...
      function vendingOffered(numSnack, numDrinks) {
       ...
       function setImages(name, numSnack, numDrinks) {
        ...
        let active = false;
        if(numSnack >= 1) {
          images = "<img src='./MunchiMaps%20Assets/" + name + "/" + image + "Snack1.jpg'?raw=true\" alt=\"Logo 1\" class=\"active\">";
          active = true;
          
          for(let i = 2; i <= numSnack; i++) {
            
            images += "<img src='./MunchiMaps%20Assets/" + name + "/" + image + "Snack" + i + ".jpg'?raw=true\" alt=\"Logo " + i + "\">";
            console.log(images);
          }
        }
        //console.log(images);
        ...
        if(numDrinks >= 1) {
          if(!active) {
            images = "<img src='./MunchiMaps%20Assets/" + name + "/"+image+"Drink1.jpg'?raw=true\" alt=\"Logo 1\" class=\"active\">";
            active = true;
          } else {
            images += "<img src='./MunchiMaps%20Assets/" + name + "/" + image + "Drink1.jpg'?raw=true\" alt=\"Logo 1\">";
          }
          for(let i = 2; i <= numDrinks; i++) {
            images += "<img src='./MunchiMaps%20Assets/" + name + "/" + image + "Drink" +i + ".jpg'?raw=true\" alt=\"Logo " + i + "\">";
          }
        }
